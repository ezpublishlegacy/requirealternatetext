...
/* making alt text required */
function uploadButtonClick(){
	if (document.getElementById('objectAltText').value == ''){
		alert('Please enter alternative text for this image.');
		return false;
	} else {
		document.getElementById('upload_in_progress').style.display = '';
...
<div class="upload-view">
    <form action="{concat('ezoe/upload/', $object_id, '/', $object_version, '/auto/1' )|ezurl}" method="post" target="embed_upload" name="EmbedForm" id="EmbedForm" enctype="multipart/form-data" onsubmit="return uploadButtonClick()">
